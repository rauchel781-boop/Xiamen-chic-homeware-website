...
const PRODUCT_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Countertop Organizers',       href: '/products/wooden-countertop-organizers' },
      { label: 'Entryway Catchall Trays',     href: '/products/entryway-catchall-trays' },
      { label: 'Wooden Jewelry Organizer',    href: '/products/wooden-jewelry-organizer' },
